 ...
 *  @author Kevin Wayne
 */
public class DictSET implements Iterable<String> {
    ...
    /**
     * Returns there is A keys in the set that start with <tt>prefix</tt>.
     * @param prefix the prefix
     * @return true - there exists a word with this prefix
     *         false - there does not exist
     */    
    public boolean hasKeyWithPrefix(String prefix) {
        /*if (buffer.contains(prefix)) return true;
        else {
    ...
    public static void main(String[] args) {
        ...
        String prefix = "QUQUQUA";
        StdOut.println(prefix.replace(prefix.charAt(prefix.length() - 1), '\0'));
        StdOut.println(prefix);
        StdOut.println("hasKeyPrefixOf(\""+prefix+"\"):");
        StdOut.println(set.hasKeyWithPrefix(prefix));
        ...
        StdOut.println("keysWithPrefix(\"AGA\"):");
        for (String s : set.keysWithPrefix("AGA"))
            StdOut.println(s);
        StdOut.println();
